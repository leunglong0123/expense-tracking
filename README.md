...
A Next.js application for tracking expenses and analyzing receipt images. Built with TypeScript, Next.js, and Tailwind CSS.
...
- Node.js 18.18.0 or later (recommended: use nvm for version management)
- npm 9.8.1 or later (comes with Node.js)
...
4. Configure environment variables
   ...
   The application uses Google's Gemini API for OCR processing of receipt images.
   ...
   The free tier includes access to Gemini Pro Vision, which is used for OCR processing in this application.
...
- `/pages` - Next.js pages and API routes
  - `index.tsx` - Homepage
  - `receipt/[id].tsx` - Receipt detail page
...
- `npm run next-dev` - Run the Next.js development server
